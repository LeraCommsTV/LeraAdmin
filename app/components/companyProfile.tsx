//components/CompanyProfile.tsx (Optional: Keep as reusable component)
'use client';
        ...
        <div key={index} className="py-6">
          ...
          <div className="flex items-center justify-between mt-4 p-4 rounded-md border border-gray-200">
            ...
            <button 
              ...
              className="bg-primary text-white text-sm px-4 py-2 rounded-md shadow font-mona font-semibold hover:bg-primary/90 transition-colors"
            >
              Download
            </button>
          </div>
