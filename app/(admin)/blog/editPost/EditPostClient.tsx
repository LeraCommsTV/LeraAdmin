// app/(admin)/blog/editPost/EditPostClient.tsx
'use client';
...
import { uploadToCloudinary, deleteFromCloudinary } from '@/lib/cloudinary'; // Assuming extractPublicIdsFromContent is used elsewhere
...
export default function EditPostClient({ searchParams }: EditPostClientProps) {
  ...
  const handleTagChange = (value: string) => {
    ...
    handleInputChange('tags' as keyof BlogPost, tags);
  };
  ...
  const handleFeaturedImageUpload = async (file: File) => {
    ...
    try {
      ...
      handleInputChange('featuredImage' as keyof BlogPost, result.url);
      handleInputChange('featuredImagePublicId' as keyof BlogPost, result.publicId); // Note: Cloudinary returns 'publicId'
    } catch (error) {
  ...
  const removeFeaturedImage = async () => {
    ...
    handleInputChange('featuredImage' as keyof BlogPost, '');
    handleInputChange('featuredImagePublicId' as keyof BlogPost, '');
  };
  ...
  const handleSave = async (status: 'draft' | 'published') => {
    ...
    try {
      ...
      delete (postData as any).id; // Ensure id isn't saved
  ...
  const generateExcerpt = () => {
    try {
      ...
      handleInputChange('excerpt' as keyof BlogPost, excerpt + (text.length > 200 ? '...' : ''));
    } catch (error) {
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {error && (
          <div className="bg-red-700 text-red-100 p-4 rounded-md mb-6">{error}</div>
        )}
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={post.title}
                    onChange={(e) => handleInputChange('title' as keyof BlogPost, e.target.value)}
                ...
                <div>
                  ...
                  <textarea
                    value={post.excerpt}
                    onChange={(e) => handleInputChange('excerpt' as keyof BlogPost, e.target.value)}
                ...
                <div>
                  ...
                  <RichTextEditor
                    value={post.content}
                    onChange={(content) => handleInputChange('content' as keyof BlogPost, content)}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      value={post.status}
                      onChange={(e) => handleInputChange('status' as keyof BlogPost, e.target.value as BlogPost['status'])}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={post.author}
                      onChange={(e) => handleInputChange('author' as keyof BlogPost, e.target.value)}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={post.category}
                      onChange={(e) => handleInputChange('category' as keyof BlogPost, e.target.value)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('date' as keyof BlogPost, e.target.value)}
                      className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded text-white"
                    />
                  </div>
                </div>
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                ...
                <input
                  type="url"
                  value={post.videoUrl || ''}
                  onChange={(e) => handleInputChange('videoUrl' as keyof BlogPost, e.target.value)}
