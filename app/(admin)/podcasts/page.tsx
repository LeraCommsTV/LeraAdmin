...
const PodcastPage = () => {
  const [episodes] = useState<PodcastEpisode[]>([
    ...
    },
    {
      ...
      description: 'Deep dive into blockchain technology applications beyond digital currencies, featuring industry experts.',
  ...
  const SidebarEpisodeCard = React.memo(({ episode }: { episode: PodcastEpisode }) => (
    <article
      ...
      className={`bg-white rounded-lg shadow-md overflow-hidden mb-4 cursor-pointer transition-all duration-300 hover:shadow-lg focus-within:ring-2 focus-within:ring-blue-500
        ${selectedEpisode?.id === episode.id ? 'ring-2 ring-blue-500 bg-blue-50' : ''}`}
      role="button"
      tabIndex={0}
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">TechTalk Podcast</h1>
              <p className="text-gray-600 mt-1">Conversations that shape the future</p>
            </div>
          </div>
        </div>
      </header>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-4">
                      <button
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full transition-colors duration-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                ...
                <div className="flex flex-wrap gap-2">
                  {categories.map((category) => (
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-sm font-medium transition-colors duration-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2
      ...
      <footer className="bg-gray-900 text-white mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <h3 className="text-xl font-bold mb-2">TechTalk Podcast</h3>
